...
<body>
    <form method="POST" action="{{ route('post_comp') }}" onsubmit="return validateTextArea()">
        @csrf
        <!-- 食事内容 -->
        <div id="meal_contents">
            <label for="meal_time1">食事時間</label>
            <input type="time" name="meal_time1" required><br><br>
            <div class="time_input_group">
                <label for="meal_comment1">内容</label>
                <textarea name="meal_comment1" placeholder="納豆、チキンステーキ、味噌汁etc..." required maxlength="50"></textarea>
            </div>
        </div>
        <button type="button" onclick="addTimeInputGroupMeal()">食事を追加＋</button></br></br>
        <!-- 運動内容 -->
        <div id="exercise_contents">
            <label for="exercise_time1">運動時間</label>
            <input type="time" name="exercise_time1" required><br><br>
            <div class="time_input_group">
                <label for="exercise_comment1">内容</label>
                <textarea name="exercise_comment1" placeholder="腕立て伏せ30回、ジョギング20分etc..." required maxlength="50"></textarea>
            </div>
        </div>
        <button type="button" onclick="addTimeInputGroupExercise()">運動を追加＋</button></br></br>
        <!-- その他 -->
        <div id="other_contents">
            <label for="other_time1">その他</label>
            <input type="time" name="other_time1" required><br><br>
            <div class="time_input_group">
                <label for="other_comment1">内容</label>
                <textarea name="other_comment1" placeholder="瞑想、サウナ、サプリメントetc..." required maxlength="50"></textarea>
            </div>
        </div>
        ...
        <div id="sleep_contents">
            ...
            <input type="time" name="rising_time" required> ～ <input type="time" name="retiring_time" required>
        </div>
